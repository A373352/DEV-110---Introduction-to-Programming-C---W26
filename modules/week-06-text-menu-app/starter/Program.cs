        ...
        while (choice != 6)
        {
            ...
            switch (choice)
            {
                ...
                case 2:
                    ...
                    string lowerFull = fullName.ToLower();
                    Console.WriteLine($"[Name Tag] {fullName}");
                    Console.WriteLine($"Initials: {initials}");
                    Console.WriteLine($"Lowercase: {lowerFull}");
                    break;
                case 3:
                    ...
                    Console.WriteLine($"Words list: {wordList}");
                    break;
                case 4:
                    ...
                    Console.WriteLine("\nITEM                QTY   TOTAL");
                    Console.WriteLine(string.Format("{0,-18} {1,3} {2,10:C2}", itemName, quantity, total));
                    break;
                case 5:
                    ...
                    Console.WriteLine(bannerTitle.ToUpper().PadLeft((width + bannerTitle.Length) / 2));
                    Console.WriteLine(bannerSubtitle.PadLeft((width + bannerSubtitle.Length) / 2));
                    Console.WriteLine(border);
                    Console.WriteLine("Alignment examples:");
                    Console.WriteLine(bannerTitle.PadLeft((width + bannerTitle.Length) / 2));
                    Console.WriteLine(bannerTitle.PadRight(width));
                    Console.WriteLine(bannerTitle.PadLeft(width));
                    break;
                case 6:
                    ...
                    bool equalsGoodbye = closing.Equals("goodbye", StringComparison.OrdinalIgnoreCase);
                    string first3 = closing.Length >= 3 ? closing.Substring(0, 3) : closing;
                    bool endsWithExcl = closing.EndsWith("!");
                    int spaceIndex = closing.IndexOf(' ');
                    Console.WriteLine($"Equals 'goodbye' (ignore case): {equalsGoodbye}");
                ...
                case 6:
                    ...
                    Console.WriteLine("--------------------------------------");
                    // Then print: "Goodbye!"
>>>>>>> adfe9d7(Cleaned code formatting)
