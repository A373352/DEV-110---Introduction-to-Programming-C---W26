            ...
            switch (choice)
            {
                ...
                case 3:
                    ...
                    else
                    {
                        ...
                        int sortChoice = ReadIntInRange("Choose sort option: ", 1, 2);
                        ...
                        if (sortChoice == 1)
                        {
                            // Name: sort names alphabetically and pair with credits
                            Array.Sort(sortedNames, sortedCredits, StringComparer.OrdinalIgnoreCase);
                        }
                        else
                        {
                            // Credits: sort credits numerically and pair with names
